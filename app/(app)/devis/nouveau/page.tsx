        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" value={formData.validite_jours} onChange={(e) => setFormData({ ...formData, validite_jours: parseInt(e.target.value) })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
            ...
            <div>
              ...
              <input type="text" value={formData.code_postal_chantier} onChange={(e) => setFormData({ ...formData, code_postal_chantier: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Ville</label>
              <input type="text" value={formData.ville_chantier} onChange={(e) => setFormData({ ...formData, ville_chantier: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
          </div>
        </div>
                ...
                {lignes.map((ligne, i) => (
                  <tr key={i} className="border-t border-gray-50">
                    ...
                    <td className="px-3 py-2">
                      <input type="text" value={ligne.designation} onChange={(e) => updateLigne(i, 'designation', e.target.value)}
                        placeholder="Désignation..."
                        className="w-full border-0 border-b border-gray-200 py-1 text-sm focus:outline-none focus:border-orange-500" />
                    </td>
                    <td className="px-3 py-2">
                      <input type="text" value={ligne.unite} onChange={(e) => updateLigne(i, 'unite', e.target.value)}
                        className="w-full border border-gray-200 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-orange-500" />
                    </td>
                    <td className="px-3 py-2">
                      <input type="number" value={ligne.quantite} onChange={(e) => updateLigne(i, 'quantite', parseFloat(e.target.value) || 0)}
                    ...
                    <td className="px-3 py-2">
                      <input type="number" step="0.01" value={ligne.prix_unitaire_ht} onChange={(e) => updateLigne(i, 'prix_unitaire_ht', parseFloat(e.target.value) || 0)}
                        className="w-full border border-gray-200 rounded px-2 py-1 text-sm text-right focus:outline-none focus:ring-1 focus:ring-orange-500" />
                    </td>
              ...
              <tfoot className="bg-gray-50">
                ...
                <tr>
                  <td colSpan={5} className="px-4 py-2 text-right text-sm font-medium text-gray-700">
                    TVA
                    <input type="number" value={formData.taux_tva} onChange={(e) => setFormData({ ...formData, taux_tva: parseFloat(e.target.value) })}
