...
import { HardHat, Receipt, FileText, Users, TrendingUp, AlertTriangle, CheckCircle, Clock } from 'lucide-react'
...
export default async function DashboardPage() {
  ...
  // Get user profile and societe_id
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <KPICard
          ...
          bg="bg-blue-50"
          link="/chantiers"
          subtitle={`${chantiers?.length || 0} au total`}
        />
        <KPICard
          ...
          bg="bg-green-50"
          link="/facturation"
          subtitle={`${factures?.length || 0} factures`}
        />
        <KPICard
          title="Montant impayé"
          value={formatCurrency(montantImpaye)}
          icon={<TrendingUp className="w-6 h-6 text-orange-600" />}
          bg="bg-orange-50"
          link="/facturation"
          subtitle={`${facturesImpayees?.length || 0} factures`}
        />
        <KPICard
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <Link href="/chantiers" className="text-sm text-orange-600 hover:underline">
              Voir tout →
            </Link>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <Link href="/devis" className="text-sm text-orange-600 hover:underline">
              Voir tout →
            </Link>
          </div>
          <div className="divide-y divide-gray-50">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm xl:col-span-2">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <Link href="/alertes" className="text-sm text-orange-600 hover:underline">
              Voir tout →
            </Link>
          </div>
          <div className="divide-y divide-gray-50">
