  ...
  return (
    <div className="p-6 max-w-2xl">
      <div className="flex items-center gap-4 mb-6">
        <Link href="/personnel" className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="text" value={formData.poste} onChange={(e) => setFormData({ ...formData, poste: e.target.value })}
              placeholder="Maçon, Chef de chantier..."
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" value={formData.nationalite} onChange={(e) => setFormData({ ...formData, nationalite: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Salaire brut (€/mois)</label>
            <input type="number" step="0.01" value={formData.salaire_brut} onChange={(e) => setFormData({ ...formData, salaire_brut: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
          </div>
          <div className="md:col-span-2">
            <h3 className="text-sm font-semibold text-gray-700 mt-2 mb-3 pt-2 border-t border-gray-100">Titre de séjour (si applicable)</h3>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Type de titre</label>
            <input type="text" value={formData.type_titre_sejour} onChange={(e) => setFormData({ ...formData, type_titre_sejour: e.target.value })}
              placeholder="Carte de résident, VLS-T..."
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Numéro</label>
            <input type="text" value={formData.numero_titre_sejour} onChange={(e) => setFormData({ ...formData, numero_titre_sejour: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Date de validité</label>
            <input type="date" value={formData.date_validite_titre} onChange={(e) => setFormData({ ...formData, date_validite_titre: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
          </div>
        </div>
