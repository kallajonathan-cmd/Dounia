              ...
              {factures && factures.length > 0 ? factures.map((f) => (
                <tr key={f.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <Link href={`/facturation/${f.id}`} className="text-sm font-medium text-gray-900 hover:text-orange-600 line-clamp-1">
                      {f.objet}
                    </Link>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-600">{(f as any).clients?.nom || '-'}</td>
                  <td className="px-4 py-3">
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full capitalize">{f.type}</span>
                  </td>
                ...
                <tr>
                  <td colSpan={9} className="px-4 py-12 text-center text-sm text-gray-400">
                    Aucune facture. <Link href="/facturation/nouveau" className="text-orange-600 hover:underline">Créer la première</Link>
                  </td>
                </tr>
              )}
            </tbody>
